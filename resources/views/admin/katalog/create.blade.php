        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tambah katalog</li>
                </ol>
            </nav>
            <h2 class="h4">Tambah katalog</h2>
            <p class="mb-0">Form tambah katalog baru.</p>
        </div>
        ...
        <form action="{{ route('katalog.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control" id="nama_katalog" name="nama_katalog" type="text"
                        value="{{ old('nama_katalog') }}" placeholder="Enter your katalog name" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="deskripsi">Deskripsi</label>
                    <input class="form-control" id="deskripsi" name="deskripsi" type="text"
                        value="{{ old('deskripsi') }}" placeholder="Desc" required>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select mb-0" id="ketersediaan" name="ketersediaan"
                        aria-label="Ketersediaan select example">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select mb-0" id="kategori" name="kategori"
                        aria-label="kategori select example">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input data-datepicker="" class="form-control datepicker-input" id="tgl_rilis" name="tgl_rilis"
                            type="date" value="{{ old('tgl_rilis') }}" placeholder="D-F-Y" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input class="form-control" id="gambar" name="gambar" type="file"
                        value="{{ old('gambar') }}" placeholder="Desc" required>
                </div>
            </div>
            <div class="mt-3">
