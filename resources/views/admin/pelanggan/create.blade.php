            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="first_name" name="first name" type="text"
                ...
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="last_name" name="last name" type="text"
                            value="{{ old('last_name') }}" placeholder="Also your last name" required="">
                    </div>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input data-datepicker="" class="form-control datepicker-input" id="birthday" name="birthday"
                            type="date" value="{{ old('birthday') }}" placeholder="dd/mm/yyyy" required="">
                        <div class="datepicker datepicker-dropdown datepicker-orient-left datepicker-orient-bottom"
                            style="left: 81px; top: 571.781px;">
                                    ...
                                    <div class="datepicker-view">
                                        <div class="days">
                                            ...
                                            <div class="datepicker-grid"><span class="datepicker-cell day prev"
                                                    ...
                                                    data-date="1728838800000">14</span><span class="datepicker-cell day"
                                                    data-date="1728925200000">15</span><span class="datepicker-cell day"
                                                    data-date="1729011600000">16</span><span
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select mb-0" id="gender" value="{{ old('gender') }}" name="gender"
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="phone" value="{{ old('phone') }}" name="phone"
                            type="number" placeholder="+12-345 678 910" required="">
                    </div>
                </div>
            </div>
