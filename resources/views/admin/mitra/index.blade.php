...
@section('content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Mitra List</h2>
            <p class="mb-0">List seluruh mitra setia calafaku-apps.</p>
        </div>
        {{-- end main content --}}
    ...
    <div class="mb-3">
        <form method="GET" action="{{ route('mitra.list') }}">
            <div class="row">
                <div class="col-md-2">
                    <select name="kemitraan" onchange="this.form.submit()" class="form-select">
                        <option value="">Kemitraan</option>
                        <option value="platinum" {{ request('kemitraan') == 'platinum' ? 'selected' : '' }}>Platinum
                        </option>
                        <option value="gold" {{ request('kemitraan') == 'gold' ? 'selected' : '' }}>Gold</option>
                        <option value="silver" {{ request('kemitraan') == 'silver' ? 'selected' : '' }}>Silver</option>
                    </select>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
    ...
    <div class="card border-0 shadow mb-4">
        <div class="card-body">
            <div class="table-responsive">
                <table id="table-mitra" class="table table-centered table-nowrap mb-0 rounded">
                    ...
                    <tbody>
                        ...
                        @foreach ($dataMitra as $row)
                            <tr>
                                <td>{{ ($dataMitra->currentPage() - 1) * $dataMitra->perPage() + $loop->iteration }}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('mitra.destroy', $row->mitra_id) }}" class="btn btn-danger btn-sm">
                ...
                {{ $dataMitra->links('pagination::bootstrap-5') }}
            </div>
        </div>
    </div>
@endsection
