        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> <a href="{{ route('mitra.list') }}">mitra</a>
                    </li>
                ...
                <div class="col-md-6 mb-3">
                    <div>
                        ...
                        <input class="form-control" id="nama_mitra" name="nama_mitra" type="text"
                            value="{{ old('nama_mitra') }}" placeholder="Enter your mitra name" required>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="telepon" name="telepon" type="tel"
                            value="{{ old('telepon') }}" placeholder="+12-345 678 910" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select mb-0" id="kemitraan" name="kemitraan" aria-label="Memilih kemitraan"
                        required>
                        <option value="" disabled selected>Kemitraan</option>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input data-datepicker class="form-control datepicker-input" id="bergabung" name="bergabung"
                            type="date" value="{{ old('bergabung') }}" placeholder="dd/mm/yyyy" required>
                    </div>
                </div>
            </div>
            <div class="mt-3">
