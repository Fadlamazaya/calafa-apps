...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand"> <img src="{{ asset('assets-admin/img/brand/logocalafa.png') }}" height="55" width="55" alt="Calafa Logo">
                Calafa Food</a>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    Tempat terbaik untuk menikmati makanan dan minuman lezat dengan harga terjangkau! Kami selalu mengutamakan
                    bahan-bahan segar dan bumbu pilihan yang diracik dengan sempurna, menghadirkan cita rasa autentik yang dapat
                    dinikmati kapan saja. Dari menu klasik yang akrab di lidah hingga kreasi inovatif yang menggugah selera,
                    setiap hidangan kami dibuat dengan sepenuh hati untuk memberikan pengalaman kuliner yang tak terlupakan di
                    setiap suapan.
                </p>
            </div>
